        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 md:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={step}
                className="card p-6 flex flex-col gap-4 hover:shadow-lg transition-shadow"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
              {MOCK_SETS.map((set) => (
                <Link key={set.id} href={`/sets/${set.id}`} className="group">
                  <div className="card p-5 h-full flex flex-col gap-3 group-hover:shadow-lg transition-shadow">
                    {/* Coloured header band (spec v2 has no banner_url) */}
                    <div className="h-24 rounded-lg bg-gradient-to-br from-[var(--primary)] to-[var(--primary-hover)] flex items-center justify-center">

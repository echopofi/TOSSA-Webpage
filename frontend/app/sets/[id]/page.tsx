      ...
      <main>
        ...
        <section className="relative h-52 md:h-72 overflow-hidden bg-[var(--text-heading)]">
          <div className="relative max-w-6xl mx-auto px-4 sm:px-6 h-full flex flex-col justify-end pb-8">
            <p className="text-white/50 text-sm mb-1">Graduating Set</p>
            <h1 className="text-3xl md:text-5xl font-[family-name:var(--font-heading)] font-semibold text-white">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {members.map((m) => (
                  <Link key={m.id} href={`/members/${m.id}`} className="group">
                    <Card className="flex items-start gap-4 group-hover:shadow-lg transition-shadow">
